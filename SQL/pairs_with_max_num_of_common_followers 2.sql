-- https://leetcode.com/problems/all-the-pairs-with-the-maximum-number-of-common-followers/description/?envType=study-plan&id=sql-iii
...
with cte as 
(
    select a.user_id as user1_id,b.user_id as user2_id,count(1) cnt 
    from relations a 
